...
"""Deterministic two-hop fixtures for ScopeAnchor's scope-propagation contract."""
...
from scopeanchor import ProposedRetrievalStep, ProposedStepError, RetrievalScope, ScopeFilters
...
async def run_clean_two_hop(
    ...
    *,
    ...
    with trace_operation("scopeanchor.retrieval", {"scopeanchor.hop": 0}) as span:
    ...
    with trace_operation("scopeanchor.planner.proposal", {"scopeanchor.hop": 1}) as span:
        ...
        span.set_attribute("scopeanchor.proposal.accepted", True)
    ...
    *,
    ...
    with trace_operation("scopeanchor.planner.proposal", {"scopeanchor.hop": 1}) as span:
        try:
            ...
            span.set_attribute("scopeanchor.proposal.accepted", False)
            span.set_attribute("scopeanchor.rejected_field_count", len(error.fields))
