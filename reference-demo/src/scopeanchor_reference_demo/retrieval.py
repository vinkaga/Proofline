...
from scopeanchor_reference_demo.domain import AccessScope, Principal, RetrievalCandidate
    ...
    def rank_for_answer(
        ...
        ranked = sorted(
            (
                ...
                if item[1] > 0
                and len(set(query_tokens) & set(document)) >= minimum_matches
                and (not requested_resources or item[0].resource_id.lower() in requested_resources)
                and all(
