...
"""Release-gate evaluation for ScopeAnchor's narrow scope-propagation claim.
...
prevent exposure after an unsafe plan is accepted, whereas ScopeAnchor rejects a
...
async def _baseline_clean_task(
    ...
    """Check clean retrieval for baselines without routing them through ScopeAnchor."""
